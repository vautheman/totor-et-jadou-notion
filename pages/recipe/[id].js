        ...
        <>
            <Layout>
                ...
                <div className='grid grid-cols-3 container mx-auto gap-16'>
                    <div className='col-span-2 relative h-screen grid grid-rows-7'>
                        <Nav />

                        <div className='relative'>
                            <div className='absolute mb-10 right-0 translate-x-1/2 2xl:translate-x-1/3 w-60 2xl:w-80'>
                            ...
                            <div className='w-4/5 flex flex-col gap-5 2xl:mt-10'>
                                <div>
                                ...
                                <h3 className='font-title text-2xl 2xl:text-3xl text-white mb-10'>Étapes à suivre</h3>
                            </div>
                        </div>


                        <div className='mask-alpha scrollbar-custom flex flex-col gap-12 overflow-y-auto mb-10 2xl:mr-12'>
                    ...
                    <div className='h-screen grid items-center py-3'>
                        <div className='bg-white rounded-3xl h-full p-3 flex flex-col justify-between'>
                            <div className='flex flex-col gap-8 py-20 px-24'>
                                ...
                                <ul className='flex flex-col gap-2 font-body font-light 2xl:text-lg'>
                                    {recipe.map(item => {
                                        return item.to_do &&
                                            <li key={item.id}>{item.to_do.rich_text[0].plain_text}</li>
                                    })}
                                </ul>
                            </div>
